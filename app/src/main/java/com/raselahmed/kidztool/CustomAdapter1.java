...
class CustomAdapter1 extends RecyclerView.Adapter<CustomAdapter1.MyViewHolder> {
    ...
    public CustomAdapter1(ArrayList<BioDict> data) {
        Data = data;
    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        myViewHolder.generalText.setTypeface(null, Typeface.BOLD_ITALIC);
        myViewHolder.scientificText.setTypeface(null, Typeface.BOLD);
